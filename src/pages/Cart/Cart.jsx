        ...
        <Navbar />
				...
				<section className="cart-section">
							...
							<div className="card-container card-horizontal-container">
								<div className="card-default">
									<div className="card-header card-horizontal-header">
										...
										<div className="card-text-div card-horizontal-text-div">
											...
											<div className="item-quantity">
												<span className="material-icons">remove_circle</span><span>2</span
									...
									<div className="card-footer">
										<button className="card-button"><a href="#">Remove From Cart</a></button>
									</div>
								</div>
							</div>
								...
								<div className="card-default">
									<div className="card-header card-horizontal-header">
										...
										<div className="card-text-div card-horizontal-text-div">
											...
											<div className="item-quantity">
												<span className="material-icons">remove_circle</span><span>1</span
												><span className="material-icons">add_circle</span>
											</div>
								...
								<div className="card-default">
									<div className="card-header card-horizontal-header">
										...
										<div className="card-text-div card-horizontal-text-div">
											...
											<div className="item-quantity">
												<span className="material-icons">remove_circle</span><span>3</span
												><span className="material-icons">add_circle</span>
											</div>
					...
					<div className="cart-summary">
						...
						<div className="cart-summary-item"><span> Total Price: </span><span> $390 </span></div>
						<div className="cart-summary-item"><span>Delivery Fee:</span><span>Free</span></div>
						<br />
						<a href="#"><button className="btn btn-secondary">Checkout</button></a>
					</div>
				</section>
